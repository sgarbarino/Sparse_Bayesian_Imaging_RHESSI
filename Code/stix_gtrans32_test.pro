FUNCTION stix_gtrans32_test,xy_flare,o_flare=o_flare,rel_f=rel_f,plot=plot
...
restore,'grid_temp.sav'
fff=read_ascii('grid_param_front.txt',temp=grid_temp)
rrr=read_ascii('grid_param_rear.txt',temp=grid_temp)
