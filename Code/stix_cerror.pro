FUNCTION stix_cerror,counts,skm=skm,perror=perror
 ...
 if n_elements(where(skm-[0,5,3] eq 0)) eq 3 then path_CE_skm = 'STIXdecomErrors_SKM053_Gordon_s.csv'
 if n_elements(where(skm-[0,4,4] eq 0)) eq 3 then path_CE_skm = 'STIXdecomErrors_SKM044_Gordon_s.csv'
