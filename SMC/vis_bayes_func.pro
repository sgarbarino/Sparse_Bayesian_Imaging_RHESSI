...
function vis_bayes_reconstr_vis, param, distr_num_src,  H, jdum, mean_param,  shape,  visxyobs, visxyrec=visxyrec, sample, N_src_expected=N_src_expected, weight_type, pc_pe_pl, prop_cel_100=prop_cel_100, phase=phase, cerberus=cerberus
...
function vis_bayes_func, param, Nsources,  weights, fl,  sample, H, types, jdum,  shape,  visxyobs, visxyrec=visxyrec, N_src_expected=N_src_expected, smcsources, wei_s=wei_s, par_s=par_s, phase=phase, cerberus=cerberus
...
;print, cerberus
  if fl eq 1 then begin ; when the algorithm converges, compute the recovered sources and the parameters of each particle.
    ...
    smcsources = vis_bayes_reconstr_vis(param, distr_num_src, H, jdum, mean_param,  shape,  visxyobs, visxyrec=visxyrec,  sample, N_src_expected=N_src_expected, weight_type, pc_pe_pl,  prop_cel_100=prop_cel_100, phase=phase, cerberus=cerberus)
