...
function AMP_FWDFIT_SOURCE2MAP, srcstr, pixel=pixel, imsize=imsize, xyoffset=xyoffset
...
return, make_map(data, xcen = xyoffset[0], ycen =xyoffset[1], dx = pixel[0], dy = pixel[1], id = 'STIX from amplitudes')
