...
function hsi_vis_bayes_compute_d, param, expon, ess_new, ess, d, da, db
...
function hsi_vis_bayes_adapt_exponent, param, expon=expon, ess_new=ess_new, ess,  like_unit, new_log_weights=new_log_weights,  log_weights, print_esp=print_esp, weights=weights,Nsources,  sample, H=H
          ...
          while (ess_new/ess ge param.imax) or (ess_new/ess le param.imin) do begin  
                ...
                d = hsi_vis_bayes_compute_d(param, expon, ess_new, ess, d, da, db)  ;compute b by the bisection method
